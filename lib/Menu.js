...
class Menu {
    constructor(){
        //a class function to validate if user input is a number
    }
    ...
    async employeeMenu(){
        ...
        let choice = await inquirer.prompt({
            ...
            choices: ["View all employees", "View employees by manager",
             "Add employee", "Update employee role", "Update employee manager", "Remove employee", "Back to main menu"]
        });
        return choice.operation;
    }
    ...
    async newDepartment(){
        let answer = await inquirer.input(
            {
                type: "input",
